...
|**Security Policy**|**Android 4 and later**|**Samsung KNOX**|**iOS 6 and later_(Above iOS 13, the device needs to be supervised)_**|**Notes**|
|:-----|:-----|:-----|:-----|:-----|
...
|**What's removed**|**iOS 6 and later_(Above iOS 13, the device needs to be supervised)_**|**Android 4 and later (including Samsung KNOX**|
|:-----|:-----|:-----|
